...
var viewerRole = func() *provider.ResourcePermissions {
...
var editorRole = func() *provider.ResourcePermissions {
	return &provider.ResourcePermissions{
		GetPath:              true,
		GetQuota:             true,
		InitiateFileDownload: true,
...
var fileEditorRole = func() *provider.ResourcePermissions {
	return &provider.ResourcePermissions{
		GetPath:              true,
		GetQuota:             true,
		InitiateFileDownload: true,
...
var uploaderRole = func() *provider.ResourcePermissions {
	return &provider.ResourcePermissions{
		Stat:               true,
		ListContainer:      true,
		GetPath:            true,
